...
special addresses are \textsf {GPSxyz, GPSCnn, GPSEnn, SPCxyz} and
\textsf {SYMxyz}, and are intended for use where it is not possible to
include the symbol in the AX.25 Information field.
...
The characters \textsf{xy} and \textsf{nn} refer to entries in the
APRS Symbol Tables. The character \textsf{z} specifies a symbol
overlay. See Chapter 20: APRS Symbols and Appendix Two for more
information.
